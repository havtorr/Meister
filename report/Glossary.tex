...
\newglossaryentry{breakpoint}{name={breakpoint}, description={A source code marker telling the debugger to halt program execution at a certain point}}
...
%C
\newglossaryentry{codecanvas}{name={Code Canvas}, description={A visualization-tool for Microsoft visual studio, showing code, diagrams and documents on a large layered ccanvas}}%TODO: URL or paper

\newglossaryentry{contourdiagram}{name={contour diagram}, description={An enhanced object diagram, showing objects, their variables and their relations to other objects\cite{Jayaraman1996}\cite{Streib2010}}}%TODO:refer to paper
...
\newglossaryentry{gdb}{name={GDB}, description={GNU debugger. A multiplatform, multilanguage CLI-debugger with tracing. \url{http://www.sourceware.org/gdb/}}}
...
\newglossaryentry{javavis}{name={JAVAVIS}, description={Tool to visualize running Java applications}}%todo:url/ref

\newglossaryentry{jinsight}{name={Jinsight}, description={An advanced debugger by IBM, supports visualization, and powerful analysis}}%TODO: ref/url

\newglossaryentry{jive}{name={JIVE}, description={An advanced debugging tool supporting visualisation, backward stepping, and querying. \url{http://www.cse.buffalo.edu/jive/}}}%TODO: refer to papers

\newglossaryentry{jql}{name={JQL}, description={Jive Query Language, used to formuate queries within the jive debugging environment}}%TODO: paper/ref
...
\newglossaryentry{tod}{name={Trace-Oriented Debugger}, description={TODO \cite{Pothier2007}}}%TODO: more info
...
\newglossaryentry{traceviewer}{name={Trace Viewer Plugin}, description={todo}}%TODO: more info
...
\newglossaryentry{whyline}{name={Whyline}, description={A query-based debugger that provides an easy way to find out why things are as they are\cite{ko2009}}}
