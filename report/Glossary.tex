...
\newglossaryentry{contourdiagram}{name={contour diagram}, description={An enhanced object diagram, showing objects, their variables and their relations to other objects}}%TODO:refer to paper
...
\newglossaryentry{gdb}{name={GDB}, description={GNU debugger. A multiplatform, multilanguage CLI-debugger with tracing}}%todo:url
...
\newglossaryentry{javavis}{name={JAVAVIS}, description={Tool to visualize running Java applications}}%todo:url
...
\newglossaryentry{jive}{name={Jive}, description={An advanced debugging tool supporting visualisation, backward stepping, and querying}}%TODO: refer to papers
