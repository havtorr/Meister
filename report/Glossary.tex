...
A essential component of sequence diagrams. Indicates when in time an object is active in a program.}}
...
A design pattern defining an architecture where data is kept separate from the component that displays it to a user. 
}}
