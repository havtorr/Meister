...
\newacronym{algol}{ALGOL}{\gls{ALGOrithmicLanguage}}

\newglossaryentry{ALGOrithmicLanguage}{name={ALGOrithmic Language}, description={
A family of imperative programming languages developed in the 1950s. Influenced many other languages e.g. C, Pascal and Ada.}}
...
The study of design and use of interfaces between humans and computers. It is also the name of the NTNU-course TDT4180~.}}
...
%L
\newglossaryentry{lambdaExpression}{name={lambda expression}, description={
Also known as anonymous function or function literal. A function definition that is not bound to an identifier. Such functions are often passed as arguments to and from other functions.}}
...
An essential component of sequence-diagrams. Indicates when, during execution, an object is active in a program.}}
...
A debugging tool that executes queries on program traces.\\
