...
This will make, among others, listener-heavy programs more understandable as the kind of listeners in use is clearly visible, removing the need to guess based on when they are invoked in the sequence-diagram.
