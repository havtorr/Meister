...
This will provide a better experience for certain scenarios, but may be useless in other cases, so a way to easily switch filters would be preferable.
For instance by enabling user-defined presets.
~\\
