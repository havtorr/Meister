...
public class JiveTabForm
{
  ...
  /**
   * The check button used to enable lock events.
   */
  private Button enableLockEvents;
  /**
  ...
  JiveTabForm(final AbstractJiveTab owner, final Composite parent)
  {
    ...
    // Control for enabling lock events
    createControlEnableLockEvents();
  ...
  private void createControlEnableLockEvents()
  {
    enableLockEvents = new Button(control, SWT.CHECK);
    enableLockEvents.setText("Enable lock events? (experimental)"); // TODO Add NLS support
    enableLockEvents.setLayoutData(new GridData());
    enableLockEvents.setSelection(false);
    enableLockEvents.addSelectionListener(new SelectionListener()
      {
        @Override
        public void widgetDefaultSelected(final SelectionEvent e)
        {
  ...
  void enableControls(final boolean enabled)
  {
    ...
    enableLockEvents.setEnabled(enabled);
  ...
  void enableLockEvents(final boolean value)
  {
    enableLockEvents.setSelection(value);
  }
  ...
  boolean generateLockEvents()
  {
    return enableLockEvents.getSelection();
  }
