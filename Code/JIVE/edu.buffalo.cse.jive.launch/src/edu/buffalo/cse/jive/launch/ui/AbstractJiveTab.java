...
public abstract class AbstractJiveTab extends AbstractLaunchConfigurationTab
{
  ...
  public void initializeFrom(final ILaunchConfiguration configuration)
  {
    ...
    try
    {
      ...
      final boolean generateLockEvents = configuration.getAttribute(PreferencesPlugin.getDefault()
          .getGenerateLockEventsKey(), false);
      jiveTabForm.enableLockEvents(generateLockEvents);
  ...
  public void performApply(final ILaunchConfigurationWorkingCopy configuration)
  {
    if (isDirty())
    {
      ...
      configuration.setAttribute(PreferencesPlugin.getDefault().getGenerateLockEventsKey(),
          jiveTabForm.generateLockEvents());
