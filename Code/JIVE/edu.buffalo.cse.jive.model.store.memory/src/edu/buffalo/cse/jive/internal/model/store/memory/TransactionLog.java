 ...
 * construction.
 */
class TransactionLog extends ReentrantReadWriteLock
{
  ...
  // TODO: push to the event
  void atomicEmpty(final IJiveEvent event)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicMethodEnter(final IJiveEvent event, final IValue caller, final IMethodContour method)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicMethodExit(final IJiveEvent event, final IMethodContour method)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicObjectNew(final IJiveEvent event, final IContextContour contour)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicRemoveContour(final IJiveEvent event, final IMethodContour method)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicTypeLoad(final IJiveEvent event, final IContextContour contour)
  {
    writeLock().lock();
    try
    {
  ...
  // TODO: push to the event
  void atomicValueSet(final IJiveEvent event, final IContour contour, final IContourMember member,
  ...
  List<IContour> getChildren(final IContour element)
  {
    readLock().lock();
    try
    {
