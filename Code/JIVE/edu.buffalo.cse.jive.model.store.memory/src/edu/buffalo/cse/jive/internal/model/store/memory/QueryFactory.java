...
public class QueryFactory implements IQueryFactory
{
  ...
  QueryFactory(final IExecutionModel model)
  {
    this.model = model;
  }
  ...
  private class ExceptionCaughtQuery extends ExceptionQuery
  {
    ...
    @Override
    protected boolean satisfies(final IJiveEvent event)
    {
   ...
   * </pre>
   */
  private abstract class JiveQuery implements EventPredicate
  {
    ...
    @Override
    public Iterator<? extends IJiveEvent> createIterator()
    {
    ...
    protected abstract boolean satisfies(final IJiveEvent event);
  }
