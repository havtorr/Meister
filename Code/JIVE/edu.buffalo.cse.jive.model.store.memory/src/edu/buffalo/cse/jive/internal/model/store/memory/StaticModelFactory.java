...
class StaticModelFactory implements IStaticModelFactory
{
  ...
  private static ConcurrentMap<IExecutionModel, StaticModelFactory> modelStores = Tools
      .newConcurrentHashMap();

  static StaticModelFactory getDefault(final ExecutionModel model)
  {
  ...
  private StaticModelFactory(final ExecutionModel model)
  {
    this.model = model;
    createKnownTypes();
  }
  ...
  private enum KnownType
  {
    ...
    {
      final Set<ITypeNodeRef> result = Tools.newHashSet();
  ...
  private abstract class Node implements INode
  {
    ...
    public String toString()
    {
      return StringTools.nodeToString(this);
    }

    @Override
    public String toXML()
    {
      return XMLTools.nodeToXML(this);
    }
  ...
  private abstract class NodeRef implements INodeRef
  {
    ...
    public String toString()
    {
      return StringTools.nodeRefToString(this);
    }
