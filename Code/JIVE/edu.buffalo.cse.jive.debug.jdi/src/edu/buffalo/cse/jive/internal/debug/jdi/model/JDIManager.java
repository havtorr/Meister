...
final class JDIManager implements IJDIManager
{
  ...
  private final boolean generateLockEvents;
  private final IJiveDebugTarget owner;
  private final IExecutionState executionState;
  private final JDIEventHandler jdiHandler;
  ...
  JDIManager(final IJiveDebugTarget owner)
  {
    ...
    try
    {
      ...
      localEvents = config.getAttribute(PreferencesPlugin.getDefault().getGenerateLocalEventsKey(),
          true);
      lockEvents = config.getAttribute(PreferencesPlugin.getDefault().getGenerateLockEventsKey(),
          false);
    ...
    this.generateLockEvents = lockEvents;
  ...
  @Override
  public boolean generateLockEvents()
  {
    return this.generateLockEvents;
  }
