        ...
        try
        {
          ...
          for (final Object o : refType.fields())
          {
            ...
            if (!f.isSynthetic() && f.name().indexOf("$") == -1)
            {
              ...
              readRequest.setSuspendPolicy(owner.generateLockEvents() ? EventRequest.SUSPEND_ALL
              ...
              writeRequest.setSuspendPolicy(owner.generateLockEvents() ? EventRequest.SUSPEND_ALL
                  : EventRequest.SUSPEND_EVENT_THREAD);
              writeRequest.enable();
    ...
    protected void createRequest()
    {
      ...
      if (manager != null)
      {
        try
        {
          ...
          request.setSuspendPolicy(owner.generateLockEvents() ? EventRequest.SUSPEND_ALL
              : EventRequest.SUSPEND_EVENT_THREAD);
          request.enable();
