...
public interface IExecutionState
{
   ...
   */
  public boolean isArrayCellUpdateLine(IContourMember var, ThreadReference thread);

  /**
   * Determines if the current line has some array modification using a field.
   */
  public boolean isArrayCellUpdateLine(IMethodContour method, IContourMember field,
   ...
   * observation.
   */
  public boolean observedVariable(IContourMember var, Value value, ThreadReference thread);
