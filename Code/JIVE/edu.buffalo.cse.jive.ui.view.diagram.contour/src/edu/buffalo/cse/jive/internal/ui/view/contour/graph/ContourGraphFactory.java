...
public final class ContourGraphFactory
{
  ...
  private static class HierarchicalLayout implements IGraphLayout
  {
    ...
    {
      this.contourToNode = Tools.newHashMap();
      this.graph = new DirectedGraph();
      this.nodeColors = Tools.newHashMap();
      this.nodeToPosition = Tools.newHashMap();
      this.staticNodes = Tools.newHashMap();
    }
  ...
  private static class TabularLayout implements IGraphLayout
  {
    ...
    public TabularLayout()
    {
      this.contourToNode = Tools.newHashMap();
      this.graph = new DirectedGraph();
      this.nodeCells = Tools.newHashMap();
      this.nodeColors = Tools.newHashMap();
      this.nodeColumns = Tools.newHashMap();
      this.nodeLayers = Tools.newHashMap();
      this.nodeSections = Tools.newHashMap();
    }
    ...
    public void updatePositions()
    {
      ...
      for (final Object o : staticNode.outgoing)
      {
        ...
        if (getColor(u) == Color.WHITE)
        {
          ...
          final Map<Integer, Integer> layerToNextCellMapping = Tools.newHashMap();
